...
class UiLeaderboardTheme extends ThemeExtension<UiLeaderboardTheme> {
  ...
  static const UiLeaderboardTheme standard = UiLeaderboardTheme(
    ...
    rowHeight: 32,
    headerHeight: 20,
    rowBackground: Color(0x26000000),
    rowBorderColor: Color(0x59FFFFFF),
    highlightBackground: Color(0x1FFFF59D),
    highlightBorderColor: Color(0xCCFFD54F),
    highlightTextColor: Color(0xFFFFF59D),
