    ...
    switch (id) {
      case EnemyId.unocoDemon:
        return const EnemyArchetype(
          ...
          collider: ColliderAabbDef(halfX: 9.5, halfY: 11.5, offsetX: -5.5, offsetY: 3.5),
      ...
      case EnemyId.grojib:
        return const EnemyArchetype(
          ...
          collider: ColliderAabbDef(halfX: 19.5, halfY: 25.0, offsetX: -5.5, offsetY: 20.0),
          health: HealthDef(hp: 2000, hpMax: 2000, regenPerSecond100: 50),
      ...
      case EnemyId.hashash:
        return const EnemyArchetype(
          ...
          collider: ColliderAabbDef(halfX: 14.0, halfY: 21.5, offsetX: 9.0, offsetY: 6.5),
      ...
      case EnemyId.derf:
        return const EnemyArchetype(
          ...
          collider: ColliderAabbDef(halfX: 11.5, halfY: 24.25, offsetX: 9.0, offsetY: 7.25),
