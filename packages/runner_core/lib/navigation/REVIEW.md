...
- `dart analyze packages/runner_core/lib/navigation` (no issues)
- `dart analyze packages/runner_core/lib/navigation packages/runner_core/lib/tuning/navigation_tuning.dart test/core/ground_enemy_locomotion_jump_snap_test.dart` (no issues)
...
- `groundSegments` should be guaranteed pre-split/disjoint by contract.
  - Streamed chunk generation already does this: `packages/runner_core/lib/track/chunk_builder.dart:102`.
  - Overlap/order is guarded in chunk generation: `packages/runner_core/lib/track/chunk_builder.dart:142`.
  - Core currently trusts provided segments when present: `packages/runner_core/lib/collision/static_world_geometry_index.dart:232`.
  - Query logic assumes sorted/disjoint segments: `packages/runner_core/lib/collision/static_world_geometry_index.dart:210`.
  - Base + streamed segments are concatenated directly: `packages/runner_core/lib/track_manager.dart:273`.

## Findings (ordered by severity)

### 1) High: Jump graph can emit physically impossible edges (ceiling/wall not validated)
Evidence:
- `packages/runner_core/lib/navigation/surface_graph_builder.dart:209`
- `packages/runner_core/lib/navigation/surface_graph_builder.dart:217`
- `packages/runner_core/lib/navigation/utils/jump_template.dart:164`
...
Evidence:
- `packages/runner_core/lib/navigation/surface_pathfinder.dart:169`
- `packages/runner_core/lib/navigation/surface_pathfinder.dart:180`
...
Evidence:
- `packages/runner_core/lib/navigation/surface_extractor.dart:38`
- `packages/runner_core/lib/navigation/surface_extractor.dart:116`
...
Evidence:
- `packages/runner_core/lib/navigation/surface_navigator.dart:292`
- `packages/runner_core/lib/navigation/surface_navigator.dart:309`
- `packages/runner_core/lib/navigation/surface_navigator.dart:317`
...
Evidence:
- `packages/runner_core/lib/navigation/surface_navigator.dart:357`
- `packages/runner_core/lib/navigation/utils/trajectory_predictor.dart:173`
...
Evidence:
- `packages/runner_core/lib/navigation/utils/trajectory_predictor.dart:112`
- `packages/runner_core/lib/navigation/utils/trajectory_predictor.dart:152`
...
Evidence:
- `packages/runner_core/lib/navigation/utils/trajectory_predictor.dart:104`
...
Evidence:
- `packages/runner_core/lib/navigation/types/surface_id.dart:48`
- `packages/runner_core/lib/navigation/types/surface_id.dart:50`
