...
void main() {
  test('enemy navigation consumes prepared terrain support before motion', () {
    final world = EcsWorld(seed: 3);
    final player = world.createEntity();
    world.transform.add(player, posX: 200, posY: 100, velX: 0, velY: 0);
    world.colliderAabb.add(player, const ColliderAabbDef(halfX: 10, halfY: 20));
    world.collision.add(player);
    world.terrainContact.add(player);
    world.terrainContact.grounded[world.terrainContact.indexOf(player)] = true;
    ...
    final spatialIndex = SurfaceSpatialIndex(index: GridIndex2D(cellSize: 32));
