...
void main() {
  test('obstacleTop falls back to highest surface when no obstacle matches X', () {
    const pattern = ChunkPattern(
      name: 'obstacle-top-fallback',
      platforms: <PlatformRel>[
        PlatformRel(x: 160.0, width: 80.0, aboveGroundTop: 64.0, thickness: 16.0),
      ],
  ...
  test('obstacleTop prefers obstacle surfaces over platform surfaces', () {
    const pattern = ChunkPattern(
      ...
      platforms: <PlatformRel>[
        PlatformRel(x: 160.0, width: 128.0, aboveGroundTop: 96.0, thickness: 16.0),
      ],
