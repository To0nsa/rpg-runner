...
| 2026-08-12 16:20 UTC / `532e6dc7` | Current-head collision/navigation budget | The strict 1,280-edge Windows benchmark passed every frozen gate from a clean master: combined controller p95/p99 31/48 microseconds, candidate p95/p99 10/10, matched flat/slope full-harness p99 259/68 microseconds, -27.91% slope overhead, bounded contact/recovery iterations, and zero warmed buffer growth across 35,000 controller plus 20,000 harness samples. This refreshes local runtime evidence at the deployed client/Core head; the production observation interval remains open. |
