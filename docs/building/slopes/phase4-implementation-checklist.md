...
the transition record in its message. Generated-output drift, migration, and
the remaining editor-wide validation paths still need this boundary before the
...
because output-drift, migration, remaining editor domains, and normal
