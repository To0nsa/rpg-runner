...
- Add status UI indicators in the HUD (active effects + timers).
- Add more damage types and profiles (fire burn, poison, etc.).
...
- Add commands/UI to switch equipped spell.
