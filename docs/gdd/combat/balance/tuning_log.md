...
Use one entry per tuning pass. Keep entries short and comparable.

## Entry Template

| Date | Scope | Change Summary | Invariant Target | Scenarios | Result | Next |
|---|---|---|---|---|---|---|
| YYYY-MM-DD | e.g. projectile set | short list of value edits | e.g. DPRS parity | S1,S3,S6 | pass/fail + notes | action |
