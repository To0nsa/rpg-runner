...
| `spell` | `eloise.arcane_haste`, `eloise.vital_surge`, `eloise.mana_infusion`, `eloise.second_wind` |
...
5. `roll` has mobility contact status (`stunOnHit`) via `MobilityImpactDef`.
