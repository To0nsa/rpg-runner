...
| `solidSpellBook` | `eloise.arcane_haste`, `eloise.arcane_ward`, `eloise.vital_surge`, `eloise.mana_infusion`, `eloise.second_wind` |
| `epicSpellBook` | `eloise.arcane_haste`, `eloise.arcane_ward`, `eloise.vital_surge`, `eloise.mana_infusion`, `eloise.second_wind` |
